...
const AddUser = () => {
  ...
  return (
    <div>
      ...
      {profilePictureUrl && <Image width={200} height={50} src={profilePictureUrl} alt="Profile" style={{ marginTop: '10px' }} />}
      ...
      {gallery.length > 0 && (
        <div style={{ display: 'flex', flexWrap: 'wrap', marginTop: '10px' }}>
          {gallery.map((image, index) => (
            <Image width={100} height={50}  key={index} src={image} alt={`Gallery ${index}`} style={{ margin: '5px' }} />
          ))}
        </div>
      )}
