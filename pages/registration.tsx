...
const Profile = () => {
  ...
  useEffect(() => {
    if (session?.user) {
      setUserDetails({
        ...
        ReceiveNotificationonWhatsApp:session.user.ReceiveNotificationonWhatsApp || "",
  ...
  // Next and previous step code
  const nextStep = () => {
    if (activeStep === 7) {
      router.push("/profile"); // Redirect to home page
    } else {
      setActiveStep((prev) => Math.min(prev + 1, 7)); // Prevent going beyond the last step
    }
  };

  const previousStep = () => {
    setActiveStep((prev) => Math.max(prev - 1, 1)); // Prevent going before the first step
  };
  ...
  if (!session)
    ...
    // const usertDate = (dateString: Date | undefined) => {
    //   const date = new Date(dateString);
  ...
  return (
    <div >
      ...
      <h1 className="head-titles">My Profile</h1>
      <h3>Whatsapp Number: {session.user.whatsappNumber} </h3>
      {/* <h3>First Name:{session.user.firstName} </h3>
      <h3>Last Name:{session.user.lastName} </h3>
      <h3>Profile:{session.user.profile} </h3>
      <h3>Gender:{session.user.gender} </h3>
      <h3>Date of Birth: {usertDate(session.user.dateOfBirth)}</h3>
      <h3>Age:{session.user.age} </h3> */}
      </div>
      ...
      <form>
        ...
        {activeStep === 1 && (
          <div className="basic-details">
            <h2 className="head-titles">
              Basic Details
            </h2>

               {/* Select Field */}
             <div>
              <label className="register-label" htmlFor="experienceLevel">Experience Level:</label>
              <select
           ...
           <>
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="maritalStatus">Marital Status:</label>
              <select
                id="maritalStatus"
                className="register-input"
            ...
            />
                ...
                {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="nativeState">Native State:</label>
              <select
                id="nativeState"
                className="register-input"
             ...
             {/* Select Field */}
             <div>
              <label className="register-label" htmlFor="nationality">Nationality :</label>
              <select
                id="nationality"
                className="register-input"
        ...
        {/* Profile Picture */}
         ...
         {/* Face Close Picture */}
          ...
          <FaceReactionVideoEdit/>
           ...
           {/* Gallery */}
        <div>
          <label htmlFor="gallery">Add [Traditional, Modern Wear] Images :<br></br></label>
          <input
            type="file"
            id="gallery"
            name="gallery"
          ...
          {/* Face Pic Gallery */}
          <div> 
                <label htmlFor="facePicGallery">Add [Face CloseUp, Straight Face, Side Pose, Without Makeup] Images :<br></br></label>
                <input
                  type="file"
                  id="facePicGallery"
                  name="facePicGallery"
           ...
           {/* Video Gallery */}
           <div>
                <label htmlFor="videoGallery">Video Gallery:</label>
                <input
                  type="file"
                  id="videoGallery"
                  name="videoGallery"
        ...
        {activeStep === 3 && (
          ...
          <>
           ...
           <>
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="bodyShape">Body Shape:</label>
              <select
                id="bodyShape"
                className="register-input"
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="bodyType">Body Type:</label>
              <select
                id="bodyType"
                className="register-input"
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="skinTone">Skin Tone:</label>
              <select
                id="skinTone"
                className="register-input"
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="eyeColor">Eye Color:</label>
              <select
                id="eyeColor"
                className="register-input"
            ...
            {/* Select Field */}
            <div>
              <label className="register-label" htmlFor="hairColor">Hair Color:</label>
              <select
                id="hairColor"
                className="register-input"
        ...
        {activeStep === 4 && (
          <>
          <div className="basic-details">
            <h2 className="head-titles">Work Details</h2>
      ...
      <div className="button-group">
            {activeStep > 1 && (
              <button
                className="text-white bg-gray-700 px-4 py-2 rounded-lg mr-2"
                type="button"
